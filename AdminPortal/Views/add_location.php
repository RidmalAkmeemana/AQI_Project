...
<head>
    ...
    <body>
					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#Add_Location" data-toggle="modal" class="btn btn-primary float-right mt-2"> <i class="fa fa-plus-square" aria-hidden="true"></i> Add Location</a>
							</div>
						</div>
					</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="POST" action="../../API/Admin/addNewBatch.php" id="addBatchForm" enctype="multipart/form-data">
								<div class="row form-row">

									<div class="col-12">
										<div class="form-group">
											<label>Batch</label>
											<input type="text" name="batchNo" class="form-control" required="">
										</div>
									</div>

									<div class="col-12">
										<div class="form-group">
											<label>Intake Title</label>
									...
									<div class="col-12">
										<div class="form-group">
											...
											<textarea id="my-text" name="description" class="form-control" rows="8" placeholder="Enter Batch Description . . ."></textarea>
        ...
        // Make an AJAX request to getBatchData.php
        $.ajax({
            type: 'POST',
            url: '../../API/Admin/getBatchData.php',
            dataType: 'json',
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, row) {
                        table.row.add([
                            ...
                            row.year,
                            row.student_count,
                            '<div class="actions"><a class="btn btn-sm bg-success-light" href="view_batch.php?batchNo=' + row.batchNo + '"><i class="fe fe-eye"></i> View </a></div>'
                        ]);
                    });
